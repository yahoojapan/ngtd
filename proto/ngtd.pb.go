...
func (*GetObjectRequest) Descriptor() ([]byte, []int) { return fileDescriptorNgtd, []int{10} }
...
func (*GetObjectResponse) Descriptor() ([]byte, []int) { return fileDescriptorNgtd, []int{11} }
...
func (c *nGTDClient) GetObject(ctx context.Context, in *GetObjectRequest, opts ...grpc.CallOption) (*GetObjectResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ngtd.NGTD/GetObject", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nGTDClient) StreamGetObject(ctx context.Context, opts ...grpc.CallOption) (NGTD_StreamGetObjectClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_NGTD_serviceDesc.Streams[4], c.cc, "/ngtd.NGTD/StreamGetObject", opts...)
	if err != nil {
		return nil, err
	}
